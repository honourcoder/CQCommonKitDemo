...
//这里还是要通过参数传递一个key，否则其他的APP获取的都是同一个key
NSString * const kUUIDKey = @"com.myApp.uuid";

@implementation CQUUIDTool
...
+ (NSString *)getUUIDInKeychain {
    ...
    NSString *getUDIDInKeychain = (NSString *)[CQUUIDTool load:kUUIDKey];
    ...
    if (!getUDIDInKeychain || [getUDIDInKeychain isEqualToString:@""] || [getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [CQUUIDTool save:kUUIDKey data:result];
        // 2.3 从keychain中获取UUID
        getUDIDInKeychain = (NSString *)[CQUUIDTool load:kUUIDKey];
    }
